...
let SAMPLE_MESSAGES: ChatMessage[] = [
  {
    id: "1",
    type: "ai",
    content: 'Chào bạn! Tôi đã phân tích toàn bộ nội dung cuốn sách. Bạn có thể hỏi tôi bất kỳ điều gì về nội dung sách, tôi sẽ trả lời và cung cấp trích dẫn cụ thể từ các trang liên quan.',
    timestamp: new Date(),
    citations: [],
    isError: false
  },
  ...
  SAMPLE_MESSAGES = [
    {
      id: "1",
      type: "ai",
      content: `Chào bạn! Tôi đã phân tích toàn bộ nội dung cuốn sách ${(window as any).responseBook?.title}. Bạn có thể hỏi tôi bất kỳ điều gì về nội dung sách, tôi sẽ trả lời và cung cấp trích dẫn cụ thể từ các trang liên quan.`,
      timestamp: new Date(),
      isError: false
    },
  ];
      ...
      setTimeout(
        () => {
          const aiResponse: ChatMessage = {
            ...
            pageReferences: Array.from({length: (window as any).responseCitations.length }, (_, i) => i + 1),
            timestamp: new Date(),
            citations: [],
            isError: false
          };
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Tham khảo */}
                      {message.pageReferences && message.citations && (
